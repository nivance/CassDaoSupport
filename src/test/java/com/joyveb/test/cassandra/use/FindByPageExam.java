...
public class FindByPageExam {
	...
	public void findbypage() {
		...
		PageIterator<String, Bet> pageIterator = dao.createPageIterator(null,
				example);
		while (pageIterator.hasNext()) {
			List<Bet> records = pageIterator.next(pageSize);
			for (Bet bet : records) {
	...
	public static void main(String[] args) {
		FindByPageExam useBet = new FindByPageExam();
